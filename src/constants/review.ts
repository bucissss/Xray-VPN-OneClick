...
import type { AssessmentStatus, OutputFormat, ReviewPriority, ReviewTimeHorizon } from '../types/review';
...
export const REVIEW_STATUSES: readonly AssessmentStatus[] = ['good', 'needs-improvement', 'missing'];
export const REVIEW_FORMATS: readonly OutputFormat[] = ['markdown', 'json'];

export const REVIEW_AREA_IDS = ['documentation', 'license', 'contribution', 'quality', 'community', 'security'] as const;
